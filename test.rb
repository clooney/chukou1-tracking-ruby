...
postData = {"tracking_number":"6A15658403318"}
tracker = Trackingmore.new()
...
=begin
url="http://api.trackingmore.com/v2/trackings/get?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=6A15658403318&orders=&lang=en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/chukou1/6A15658403318/en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
postData = [
   {"tracking_number": "6A15658403318","carrier_code":"chukou1","title":"4PX page","customer_name":"trackingmore user","customer_email":"service@trackingmore.com","order_id":"#123","order_create_time":"2018/09/08 16:51","destination_code":"US","tracking_ship_date":"20180908","tracking_postal_code":"12201","lang":"en","logistics_channel":"API TEST"},
...
=begin
url="http://api.trackingmore.com/v2/trackings/chukou1/6A15658403318"
...
postData = {"tracking_number": "6A15658403318","carrier_code":"chukou1","destination_code": "US","tracking_ship_date":"20180908","tracking_postal_code":"12201","specialNumberDestination":"UK","order":"#123","order_create_time":"2018/09/08 16:51","lang":"en"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = {"tracking_number":"6A15658403318","carrier_code":"chukou1","update_carrier_code":"china-ems"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [
   {"tracking_number":"6A15658403318","carrier_code":"chukou1"},
...
postData = [{"carrier_code":"chukou1","destination":"US","original":"CN"},{"carrier_code":"china-ems","destination":"US","original":"CN"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"tracking_number":"6A15658403318","carrier_code":"chukou1"},{"tracking_number":"LZ448865302CN","carrier_code":"china-ems"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
